...
public class Product {
    ...
    private final IntegerProperty price = new SimpleIntegerProperty(this, "price", 0);
    private final StringProperty manufact = new SimpleStringProperty(this, "manufact", null);
    ...
    public final String getManufact() {
        return manufact.get();
    }
    ...
    public String toString() {
        return "Product " + getName() + " manufactura " + getManufact() + "weight" + getWeight() + "price " + getPrice();
    }
